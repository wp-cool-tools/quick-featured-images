 ...
 ?>
		...
		<div id="qfi_footer">
			<div class="qfi_content">
				<h2><?php esc_html_e( 'Credits and informations', 'quick-featured-images' ); ?></h2>
				<dl>
					...
					<dt><?php esc_html_e( 'Do you need support or have an idea for the plugin?', 'quick-featured-images' ); ?></dt><dd><a href="http://wordpress.org/support/plugin/quick-featured-images"><?php esc_html_e( 'Post your questions and ideas about Quick Featured Images in the forum at wordpress.org!', 'quick-featured-images' ); ?></a></dd>
